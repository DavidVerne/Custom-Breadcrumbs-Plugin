 ...
 * Plugin URI:        http://example.com/breadcrumbs-uri/
 * Description:       A simple breadcrumbs plugin to display all visited pages leading from the homepage to the currently viewed page
 * Version:           1.0.0
 * Author:            David Verne
...
/**
 * This code makes the magic happen
 */
